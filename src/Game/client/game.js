...
export default function GameState() {
    ...
    //     this.load.tilemap('map', 'img/maps/minimap_client.json', null, window.Phaser.Tilemap.TILED_JSON);
    //     this.load.spritesheet('tileset', 'img/tilesheet/tilesheet.png',32,32);
    //     this.load.atlasJSONHash('atlas4', 'img/sprites/atlas4.png', 'img/sprites/atlas4.json'); // Atlas of monsters
    //     this.load.spritesheet('bubble', 'img/sprites/bubble2.png',5,5); // tilesprite used to make speech bubbles
    //     this.load.spritesheet('life', 'img/sprites/lifelvl.png',5,18); // tilesprite used to make lifebar
    //     // this.load.audio('sounds','img/audio/sounds.mp3','assets/audio/sounds.ogg'); // audio sprite of all sound effects
    //     this.load.json('entities', 'img/json/entities_client.json'); // Basically a list of the NPC, mapping their id to the key used in other JSON files
    // };
