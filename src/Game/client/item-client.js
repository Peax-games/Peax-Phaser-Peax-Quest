...
export default function Item(x,y,key){
...
Item.prototype.display = function(){
    ...
    if(!this.shadow) this.shadow = this.addChild(this.game.add.sprite(1, 0, 'atlas1','shadow'));
    if(!this.sparks) {
        this.sparks = this.addChild(this.game.add.sprite(0,0, 'atlas1','sparks_0'));
